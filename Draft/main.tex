...
Then we provide two experiment setup to test these theories.

\section{Theory}
In this section multiple subjects are stated that will likely negatively impact a prototype session. These subjects are based on the theory from kahneman, \emph{Thinking fast and slow}.
...
\input{experiment}
\input{Experiment_System2Depletion}
